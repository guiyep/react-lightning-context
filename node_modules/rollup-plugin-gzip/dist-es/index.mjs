...
function gzipPlugin(explicitOptions = {}) {
    ...
    const options = Object.assign({ 
        // default options
        filter: /\.(js|mjs|json|css|html)$/, fileName: '.gz', customCompression: (fileContent) => gzipPromise(fileContent, options.gzipOptions), gzipOptions: {}, additionalFiles: [], additionalFilesDelay: 0, minSize: 0 }, explicitOptions);
